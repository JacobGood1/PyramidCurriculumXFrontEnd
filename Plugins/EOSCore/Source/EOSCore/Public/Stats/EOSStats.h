...
public:
    UFUNCTION(BlueprintCallable, BlueprintPure, Category = "EOSCore|Interfaces")
		static UCoreStats* GetStats() { return s_StatsObject; }
public:
    /**
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "EOSCore|Stats", meta = (WorldContext = "worldContextObject"))
...
private:
    static UCoreStats* s_StatsObject;
};
