...
public:
    UFUNCTION(BlueprintCallable, BlueprintPure, Category = "EOSCore|Interfaces")
		static UCorePlayerDataStorage* GetPlayerDataStorage() { return s_PlayerDataStorageObject; }
public:
    /**
    ...
    */
    UFUNCTION(BlueprintCallable, Category = "EOSCore|PlayerDataStorage", meta = (WorldContext = "worldContextObject"))
...
private:
    ...
    static void Internal_OnPlayerDataStorageDeleteCacheCallback(const EOS_PlayerDataStorage_DeleteCacheCallbackInfo* data);
private:
    ...
    static UCorePlayerDataStorage* s_PlayerDataStorageObject;
};
