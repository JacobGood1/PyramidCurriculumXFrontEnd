...
public:
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "PlayerDataStorage")
		FEOSProductUserId LocalUserId;
public:
	explicit FEOSPlayerDataStorageDeleteCacheOptions()
		: ApiVersion(EOS_PLAYERDATASTORAGE_DELETECACHEOPTIONS_API_LATEST)
		{}
};
...
public:
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "PlayerDataStorage")
		FEOSProductUserId LocalUserId;
public:
	explicit FEOSPlayerDataStorageDeleteCacheCallbackInfo()
        : ResultCode(EOSResult::EOS_ServiceFailure)
        , ClientData(nullptr){ }
	FEOSPlayerDataStorageDeleteCacheCallbackInfo(const EOS_PlayerDataStorage_DeleteCacheCallbackInfo& data)
		: ResultCode(EOSHelpers::ToEOSCoreResult(data.ResultCode))
		, ClientData(data.ClientData)
		, LocalUserId(data.LocalUserId) 
		{}
...
DECLARE_DYNAMIC_DELEGATE_OneParam(FOnDeleteCacheCompleteCallback, const FEOSPlayerDataStorageDeleteCacheCallbackInfo&, data);
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnDeleteCacheCompleteCallbackDelegate, const FEOSPlayerDataStorageDeleteCacheCallbackInfo&, data);
...
struct FDeleteCacheCompleteCallback
{
public:
	UCorePlayerDataStorage* PlayerDataStorageObject;
	FOnDeleteCacheCompleteCallback Callback;
public:
	FDeleteCacheCompleteCallback(UCorePlayerDataStorage* obj, const FOnDeleteCacheCompleteCallback& callback)
		: PlayerDataStorageObject(obj)
		, Callback(callback)
	{}
};