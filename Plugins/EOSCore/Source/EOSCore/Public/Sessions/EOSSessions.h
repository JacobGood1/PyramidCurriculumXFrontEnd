...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "EOSCore|Interfaces")
		static UCoreSessions* GetSessions() { return s_SessionsObject; }
public:
	/**
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Sessions", meta = (WorldContext = "worldContextObject"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Sessions|Memory")
		static void EOSSessionModificationRelease(UObject* worldContextObject, const FEOSHSessionModification& handle);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Sessions|Memory")
		static void EOSActiveSessionRelease(UObject* worldContextObject, const FEOSHActiveSession& handle);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Sessions|Memory")
		static void EOSSessionDetailsRelease(UObject* worldContextObject, const FEOSHSessionDetails& handle);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Sessions|Memory")
		static void EOSSessionSearchRelease(UObject* worldContextObject, const FEOSHSessionSearch& handle);
private:
...
private:
	static UCoreSessions* s_SessionsObject;
};
