...
public:
	explicit FBucketId() { }
	FBucketId(FString data)
	{
		FCStringAnsi::Strncpy(m_BucketId, TCHAR_TO_UTF8(*data), 256);
	}
public:
	FString ToString() const
	{
		return FString(UTF8_TO_TCHAR(m_BucketId));
	}
public:
...
public:
	...
	FSessionInviteId(FString data)
	{
		FCStringAnsi::Strncpy(m_SessionInviteId, TCHAR_TO_UTF8(*data), 512);
	}
public:
	FString ToString() const
	{
		return FString(UTF8_TO_TCHAR(m_SessionInviteId));
	}
public:
	operator const char*() const
	{
		return m_SessionInviteId;
	}
private:
	char m_SessionInviteId[512];
};
