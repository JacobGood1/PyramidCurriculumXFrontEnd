...
public:
     ...
     */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Authentication", meta = (WorldContext = "worldContextObject"))
	...
	*/
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "EOSCore|Authentication", meta = (DisplayName = "EOSAuth Get Login Status (Pure)"))
		static EOSELoginStatus EOSAuthGetLoginStatusPure(UObject* worldContextObject, FEOSEpicAccountId localUserId) { return EOSAuthGetLoginStatus(worldContextObject, localUserId); }
