...
public:
    UFUNCTION(BlueprintCallable, BlueprintPure, Category = "EOSCore|Interfaces")
		static UCoreEcom* GetEcom() { return s_EcomObject; }
public:
	/**
	...
	*/
    UFUNCTION(BlueprintCallable, Category = "EOSCore|Ecom", meta = (WorldContext = "worldContextObject"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Ecom", meta = (WorldContext = "worldContextObject"))
		static EOSResult EOSEcomTransaction_GetTransactionId(UObject* worldContextObject, const FEOSEcomHTransaction& handle, FString& transactionId);
