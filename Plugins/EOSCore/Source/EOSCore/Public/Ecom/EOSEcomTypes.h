...
public:
	...
	{
		FString String = FString(UTF8_TO_TCHAR(data));
		FCStringAnsi::Strncpy(m_ItemId, TCHAR_TO_UTF8(*String), (String.Len() + 1));
	}
public:
	operator EOS_Ecom_CatalogItemId() const { return m_ItemId; }
private:
	char m_ItemId[512];
};
...
public:
	...
	{
		FString String = FString(UTF8_TO_TCHAR(data));
		FCStringAnsi::Strncpy(m_OfferId, TCHAR_TO_UTF8(*String), (String.Len() + 1));
	}
public:
	operator EOS_Ecom_CatalogOfferId() const { return m_OfferId; }
private:
	char m_OfferId[512];
};
...
public:
	...
	{
		FString String = FString(UTF8_TO_TCHAR(data));
		FCStringAnsi::Strncpy(m_Name, TCHAR_TO_UTF8(*String), (String.Len() + 1));
	}
public:
	operator EOS_Ecom_EntitlementName() const { return m_Name; }
private:
	char m_Name[512];
};
...
public:
	...
	{
		FString String = FString(UTF8_TO_TCHAR(data));
		FCStringAnsi::Strncpy(m_EntitlementId, TCHAR_TO_UTF8(*String), (String.Len() + 1));
	}
public:
	operator EOS_Ecom_EntitlementId() const { return m_EntitlementId; }
private:
	char m_EntitlementId[512];
};
