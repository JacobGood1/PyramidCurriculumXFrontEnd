...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure, Category = "EOSCore|Interfaces")
		static UCoreTitleStorage* GetTitleStorage() { return s_TitleStorageObject; }
public:
	/**
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|TitleStorage", meta = (WorldContext = "worldContextObject"))
	 ...
	 */
	  ...
	  */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|TitleStorage", meta = (WorldContext = "worldContextObject"))
		static EOSResult EOSTitleStorageFileTransferRequestGetFileRequestState(UObject* worldContextObject, FEOSTitleStorageFileTransferRequestHandle handle);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|TitleStorage", meta = (WorldContext = "worldContextObject"))
		static EOSResult EOSTitleStorageFileTransferRequestGetFilename(UObject* worldContextObject, FEOSTitleStorageFileTransferRequestHandle handle, int32 filenameStringBufferSizeBytes, FString& outStringBuffer);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|TitleStorage", meta = (WorldContext = "worldContextObject"))
		static EOSResult EOSTitleStorageFileTransferRequestCancelRequest(UObject* worldContextObject, FEOSTitleStorageFileTransferRequestHandle handle);
private:
...
private:
    static UCoreTitleStorage* s_TitleStorageObject;
