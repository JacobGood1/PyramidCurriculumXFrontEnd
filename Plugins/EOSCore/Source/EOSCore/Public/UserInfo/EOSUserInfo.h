...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure, Category = "EOSCore|Interfaces")
		static UCoreUserInfo* GetUserInfo() { return s_UserInfoObject; }
public:
    /**
    ...
    */
    UFUNCTION(BlueprintCallable, Category = "EOSCore|UserInfo", meta = (WorldContext = "worldContextObject"))
...
private:
    static UCoreUserInfo* s_UserInfoObject;
};
