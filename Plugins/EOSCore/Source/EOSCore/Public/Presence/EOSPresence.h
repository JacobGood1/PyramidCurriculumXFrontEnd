...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure, Category = "EOSCore|Interfaces")
		static UCorePresence* GetPresence() { return s_PresenceObject; }
public:
	/**
	...
	*/
    UFUNCTION(BlueprintCallable, Category = "EOSCore|Presence", meta = (WorldContext = "worldContextObject"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Presence", meta = (WorldContext = "worldContextObject"))
		static EOSResult EOSPresenceCreatePresenceModification(UObject* worldContextObject, FEOSPresenceCreatePresenceModificationOptions options, FEOSHPresenceModification& handle);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Presence", meta = (AutoCreateRefTerm = "callback", WorldContext = "worldContextObject"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Presence", meta = (WorldContext = "worldContextObject"))
		static void EOSPresenceRemoveNotifyOnPresenceChanged(UObject* worldContextObject, FEOSNotificationId id);
	...
	*/
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Presence", meta = (WorldContext = "worldContextObject"))
		static void EOSPresenceModificationRelease(UObject* worldContextObject, const FEOSHPresenceModification& handle);
private:
...
private:
    static UCorePresence* s_PresenceObject;
};
