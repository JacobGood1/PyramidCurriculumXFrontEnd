...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure, Category = "EOSCore|Interfaces")
        static UCoreAchievements* GetAchievements() { return s_AchievementsObject; }
public:
    /**
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "EOSCore|Achievements", meta = (WorldContext = "worldContextObject"))
...
private:
    static UCoreAchievements* s_AchievementsObject;
};
