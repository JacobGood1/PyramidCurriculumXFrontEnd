...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "EOSCore|Interfaces")
		static UCoreFriends* GetFriends() { return s_FriendsObject; }
public:
	/**
	...
	*/
    UFUNCTION(BlueprintCallable, Category = "EOSCore|Friends", meta = (WorldContext = "worldContextObject"))
...
private:
	static UCoreFriends* s_FriendsObject;
};
