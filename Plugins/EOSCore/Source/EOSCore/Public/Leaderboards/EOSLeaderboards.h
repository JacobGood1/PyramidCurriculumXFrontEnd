...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure, Category = "EOSCore|Interfaces")
		static UCoreLeaderboards* GetLeaderboards() { return s_LeaderboardsObject; }
public:
    /**
    ...
    */
    UFUNCTION(BlueprintCallable, Category = "EOSCore|Leaderboards", meta = (WorldContext = "worldContextObject"))
...
private:
    static UCoreLeaderboards* s_LeaderboardsObject;
};
