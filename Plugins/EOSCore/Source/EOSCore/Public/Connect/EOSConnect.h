...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure, Category = "EOSCore|Interfaces")
        static UCoreConnect* GetConnect() { return s_ConnectObject; }
public:
    /**
    ...
    */
    UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "worldContextObject"))
		void EOSConnectLogin(UObject* worldContextObject, FEOSConnectLoginOptions options, const FOnLoginCallback& callback);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "worldContextObject"))
		void EOSConnectCreateUser(UObject* worldContextObject, FEOSConnectCreateUserOptions options, const FOnCreateUserCallback& callback);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "worldContextObject"))
		void EOSConnectLinkAccount(UObject* worldContextObject, FEOSConnectLinkAccountOptions options, const FOnLinkAccountCallback& callback);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "worldContextObject"))
		void EOSConnectUnlinkAccount(UObject* worldContextObject, FEOSConnectUnlinkAccountOptions options, const FOnUnlinkAccountCallback& callback);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "worldContextObject"))
		void EOSConnectCreateDeviceId(UObject* worldContextObject, FEOSConnectCreateDeviceIdOptions options, const FOnCreateDeviceIdCallback& callback);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "worldContextObject"))
		void EOSConnectDeleteDeviceId(UObject* worldContextObject, FEOSConnectDeleteDeviceIdOptions options, const FOnDeleteDeviceIdCallback& callback);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "worldContextObject"))
		void EOSConnectTransferDeviceIdAccount(UObject* worldContextObject, FEOSConnectTransferDeviceIdAccountOptions options, const FOnTransferDeviceIdAccountCallback& callback);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "worldContextObject"))
		void EOSConnectQueryExternalAccountMappings(UObject* worldContextObject, FEOSConnectQueryExternalAccountMappingsOptions options, const FOnQueryExternalAccountMappingsCallback& callback);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "worldContextObject"))
		void EOSConnectQueryProductUserIdMappings(UObject* worldContextObject, FEOSConnectQueryProductUserIdMappingsOptions options, const FOnQueryProductUserIdMappingsCallback& callback);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "worldContextObject"))
		static FEOSProductUserId EOSConnectGetExternalAccountMapping(UObject* worldContextObject, FEOSConnectGetExternalAccountMappingsOptions options);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "worldContextObject"))
		static EOSResult EOSConnectGetProductUserIdMapping(UObject* worldContextObject, FEOSConnectGetProductUserIdMappingOptions options, FString& outString);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "worldContextObject"))
		static int32 EOSConnectGetProductUserExternalAccountCount(UObject* worldContextObject, FEOSConnectGetProductUserExternalAccountCountOptions options);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "worldContextObject"))
		static EOSResult EOSConnectCopyProductUserExternalAccountByIndex(UObject* worldContextObject, FEOSConnectCopyProductUserExternalAccountByIndexOptions options, FEOSConnectExternalAccountInfo& outExternalAccountInfo);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "worldContextObject"))
		static EOSResult EOSConnectCopyProductUserExternalAccountByAccountType(UObject* worldContextObject, FEOSConnectCopyProductUserExternalAccountByAccountTypeOptions options, FEOSConnectExternalAccountInfo& outExternalAccountInfo);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "worldContextObject"))
		static EOSResult EOSConnectCopyProductUserExternalAccountByAccountId(UObject* worldContextObject, FEOSConnectCopyProductUserExternalAccountByAccountIdOptions options, FEOSConnectExternalAccountInfo& outExternalAccountInfo);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "worldContextObject"))
		static EOSResult EOSConnectCopyProductUserInfo(UObject* worldContextObject, FEOSConnectCopyProductUserInfoOptions options, FEOSConnectExternalAccountInfo& outExternalAccountInfo);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "worldContextObject"))
		static int32 EOSConnectGetLoggedInUsersCount(UObject* worldContextObject);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "worldContextObject"))
		static FEOSProductUserId EOSConnectGetLoggedInUserByIndex(UObject* worldContextObject, int32 index);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "worldContextObject"))
		static EEOSELoginStatus EOSConnectGetLoginStatus(UObject* worldContextObject, FEOSProductUserId localUserId);
	...
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "EOSCore|Connect", meta = (DisplayName = "EOSConnect Get Login Status (Pure)"))
		static EEOSELoginStatus EOSConnectGetLoginStatusPure(UObject* worldContextObject, FEOSProductUserId localUserId) { return EOSConnectGetLoginStatus(worldContextObject, localUserId); }
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "worldContextObject"))
		static FEOSNotificationId EOSConnectAddNotifyAuthExpiration(UObject* worldContextObject, const FOnAuthExpirationCallback& callback);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "worldContextObject"))
		static void EOSConnectRemoveNotifyAuthExpiration(UObject* worldContextObject, FEOSNotificationId id);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "worldContextObject"))
		static FEOSNotificationId EOSConnectAddNotifyLoginStatusChanged(UObject* worldContextObject, const FOnLoginStatusChangedCallback& callback);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "worldContextObject"))
		static void EOSConnectRemoveNotifyLoginStatusChanged(UObject* worldContextObject, FEOSNotificationId id);
private:
...
private:
    static UCoreConnect* s_ConnectObject;
};
