...
public:
    UFUNCTION(BlueprintCallable, BlueprintPure, Category = "EOSCore|Interfaces")
		static UCoreP2P* GetP2P() { return s_P2PObject; }
public:
	/**
	 ...
	 */
    UFUNCTION(BlueprintCallable, Category = "EOSCore|P2P", meta = (WorldContext = "worldContextObject"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|P2P", meta = (WorldContext = "worldContextObject"))
		void EOSP2PRemoveNotifyPeerConnectionRequest(UObject* worldContextObject, FEOSNotificationId id);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|P2P", meta = (WorldContext = "worldContextObject"))
		void EOSP2PRemoveNotifyPeerConnectionClosed(UObject* worldContextObject, FEOSNotificationId id);
