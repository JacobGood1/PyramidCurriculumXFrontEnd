...
public:
    UFUNCTION(BlueprintCallable, BlueprintPure, Category = "EOSCore|Interfaces")
		static UCoreMetrics* GetMetrics() { return s_MetricsObject; }
public:
    /**
    ...
    */
    UFUNCTION(BlueprintCallable, Category = "EOSCore|Metrics", meta = (WorldContext = "worldContextObject"))
...
private:
   static UCoreMetrics* s_MetricsObject;
};
